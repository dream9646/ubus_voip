...
//classid 65292 9.99.11 POTS VoIP Supplemental 1 ME

static unsigned short 
meinfo_cb_65292_meid_gen(unsigned short instance_num)
{
...
struct meinfo_callback_t meinfo_cb_alu_65292 = {
	.meid_gen_cb	= meinfo_cb_65292_meid_gen,
};
