...
static int 
meinfo_cb_65313_create(struct me_t *me, unsigned char attr_mask[2])
{
	...
	for( attr_order=3; attr_order <= 16; attr_order++) {
...
struct meinfo_callback_t meinfo_cb_alu_65313 = {
	.create_cb	= meinfo_cb_65313_create
};
