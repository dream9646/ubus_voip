...
static int 
meinfo_cb_65300_create(struct me_t *me, unsigned char attr_mask[2])
{
	struct meinfo_t *miptr=NULL;
	struct attr_value_t attr;
	unsigned char attr_order;
	unsigned char attr_mask2[2]={0x30,0x00};
...
struct meinfo_callback_t meinfo_cb_alu_65300 = {
	.create_cb	= meinfo_cb_65300_create
};
