...
//classid 65310 9.99.129 Dot3ah EFM Local Statistics

static unsigned short 
meinfo_cb_65310_meid_gen(unsigned short instance_num)
{
	struct me_t *parent_me=meinfo_me_get_by_instance_num(11, instance_num);
	if (!parent_me || meinfo_me_is_exist(65310, parent_me->meid)) {
...
struct meinfo_callback_t meinfo_cb_alu_65310 = {
	.meid_gen_cb	= meinfo_cb_65310_meid_gen,
};
