...
static int 
meinfo_cb_65282_create(struct me_t *me, unsigned char attr_mask[2])
{
...
struct meinfo_callback_t meinfo_cb_alu_65282 = {
	.create_cb	= meinfo_cb_65282_create
};
