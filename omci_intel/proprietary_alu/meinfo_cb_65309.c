...
//classid 65309 9.99.128 Dot3ah EFM Remote Config Data

static unsigned short 
meinfo_cb_65309_meid_gen(unsigned short instance_num)
{
	struct me_t *parent_me=meinfo_me_get_by_instance_num(11, instance_num);
	if (!parent_me || meinfo_me_is_exist(65309, parent_me->meid)) {
...
struct meinfo_callback_t meinfo_cb_alu_65309 = {
	.meid_gen_cb	= meinfo_cb_65309_meid_gen,
};
