 ...
 * Module  : er_group_hw
 * File    : er_group_hw_47_262_266_268_277_280_402.c
 *
 ******************************************************************/
...
int
er_group_hw_mac_traffic_control_td_us_gem_iwtp_tm_rate_controlled(int action, struct er_attr_group_instance_t *attr_inst, struct me_t *me, unsigned char attr_mask[2])
{
