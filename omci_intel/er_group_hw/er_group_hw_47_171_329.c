...
// 47@2,171@8
int 
er_group_hw_l2s_dscp_vlan_tagging_rxtagging_map_veip(int action, struct er_attr_group_instance_t *attr_inst, struct me_t *me, unsigned char attr_mask[2])
{
...
// 47@2,171@6
int
er_group_hw_l2s_tags_create_add012_veip(int action, struct er_attr_group_instance_t *attr_inst, struct me_t *me, unsigned char attr_mask[2])
{
	// this is to handle vtagging(171) bond on veip(329) but not bport(47) directly	
