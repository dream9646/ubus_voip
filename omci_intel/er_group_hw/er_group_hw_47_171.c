...
// 47@2, 171@8
int 
er_group_hw_l2s_dscp_vlan_tagging_rxtagging_map_bridge(int action, struct er_attr_group_instance_t *attr_inst, struct me_t *me, unsigned char attr_mask[2])
{
	if (attr_inst == NULL) {
...
//47@2,171@6
int
er_group_hw_l2s_tags_create_add012_bridge(int action, struct er_attr_group_instance_t *attr_inst, struct me_t *me, unsigned char attr_mask[2])
{
	if (attr_inst == NULL) {
       		dbprintf(LOG_ERR,"attr_inst NULL\n");
		return -1;
