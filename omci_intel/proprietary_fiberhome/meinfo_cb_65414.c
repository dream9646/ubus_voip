...
//classid 65414 9.99.12 WRI_POS_config_data

static int 
meinfo_cb_65414_create(struct me_t *me, unsigned char attr_mask[2])
{
...
static int
meinfo_cb_65414_entry_isdel(unsigned short classid, unsigned char attr_order, unsigned char *entry)
{
	int i;
...
struct meinfo_callback_t meinfo_cb_fiberhome_65414 = {
	.create_cb			= meinfo_cb_65414_create,
	.table_entry_isdel_cb	= meinfo_cb_65414_entry_isdel
};
