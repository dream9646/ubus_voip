...
int 
me_related_134_65289(struct me_t *me1, struct me_t *me2)	
{
	...
	if ((unsigned char)(attr1.data)==4 && (unsigned short)(attr2.data)==me1->meid)
		return 1;
	else
		return 0;
}
...
int 
me_related_134_65290(struct me_t *me1, struct me_t *me2)	
{
	struct attr_value_t attr1;
	struct attr_value_t attr2;
...
// relation to 9.99.17 [65315] ExtIpHostConfigData
int
me_related_134_65315(struct me_t *me1, struct me_t *me2)
{
	return me_related_65315_134(me2, me1);
}
