...
// relation check for 9.2.5 [281] Multicast_GEM_IWTP

// relation to 9.99.27 [65289] OamMep
int 
me_related_281_65289(struct me_t *me1, struct me_t *me2)	
{
	...
	if ((unsigned char)(attr1.data)==6 && (unsigned short)(attr2.data)==me1->meid)
		return 1;
	else
		return 0;
}
...
int 
me_related_281_65290(struct me_t *me1, struct me_t *me2)	
{
	struct attr_value_t attr1;
	struct attr_value_t attr2;
