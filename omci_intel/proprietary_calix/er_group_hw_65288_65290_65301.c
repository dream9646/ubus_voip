 ...
 * Module  : er_group_hw
 * File    : er_group_hw_65288_65290_65301.c
 *
 ******************************************************************/
...
//9.99.28 65289 OamMip
//9.99.36 65301 OamMipStats

// 65288@3 [0]
// 65290@1,2,3,4 [1-4]
// 65301@15 [5]
int 
er_group_hw_oam_mip_clear_counters(int action, struct er_attr_group_instance_t *attr_inst, struct me_t *me, unsigned char attr_mask[2])
{
	...
	case ER_ATTR_GROUP_HW_OP_ADD:
		if((cfm_config = cfm_mp_find(md_level, mepid, port_type, port_type_index)) != NULL) {
			...
			if (is_clear) memset(cfm_config->cfm_pkt_pm, 0, sizeof(cfm_config->cfm_pkt_pm));
		}
		break;
	...
	case ER_ATTR_GROUP_HW_OP_UPDATE:
		//delete
		if (er_group_hw_oam_mip_clear_counters(ER_ATTR_GROUP_HW_OP_DEL, attr_inst, me, attr_mask) < 0)
		{
		...
		//add
		if (er_group_hw_oam_mip_clear_counters(ER_ATTR_GROUP_HW_OP_ADD, current_attr_inst, me, attr_mask) < 0)
		{
