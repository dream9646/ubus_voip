 ...
 * Module  : er_group_hw
 * File    : er_group_hw_65288_65289_65294.c
 *
 ******************************************************************/
...
//9.99.32 65294 OamMepExt

// 65288@3 [0]
// 65289@1,2,4,5 [1-4]
// 65294@2 [5]
int 
er_group_hw_oam_mep_pm_macaddr(int action, struct er_attr_group_instance_t *attr_inst, struct me_t *me, unsigned char attr_mask[2])
{
	...
	case ER_ATTR_GROUP_HW_OP_ADD:
		if((cfm_config = cfm_mp_find(md_level, mepid, port_type, port_type_index)) != NULL) {
			memcpy(&cfm_config->cfm_send_dmm_mac, (unsigned char *) attr_inst->er_attr_instance[5].attr_value.ptr, IFHWADDRLEN);
			memcpy(&cfm_config->cfm_send_lmm_mac, (unsigned char *) attr_inst->er_attr_instance[5].attr_value.ptr, IFHWADDRLEN);
		}
		break;
	...
	case ER_ATTR_GROUP_HW_OP_UPDATE:
		//delete
		if (er_group_hw_oam_mep_pm_macaddr(ER_ATTR_GROUP_HW_OP_DEL, attr_inst, me, attr_mask) < 0)
		{
		...
		//add
		if (er_group_hw_oam_mep_pm_macaddr(ER_ATTR_GROUP_HW_OP_ADD, current_attr_inst, me, attr_mask) < 0)
		{
