...
// relation check for 9.3.10 [130] 802.1p_mapper_service_profile

// relation to 9.99.27 [65289] OamMep
int 
me_related_130_65289(struct me_t *me1, struct me_t *me2)	
{
	...
	if ((unsigned char)(attr1.data)==3 && (unsigned short)(attr2.data)==me1->meid)
		return 1;
	else
		return 0;
}
...
int 
me_related_130_65290(struct me_t *me1, struct me_t *me2)	
{
	struct attr_value_t attr1;
	struct attr_value_t attr2;
