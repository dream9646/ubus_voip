 ...
 * Module  : er_group_hw
 * File    : er_group_hw_65288_65289_65299.c
 *
 ******************************************************************/
...
//9.99.35 65299 OamMepStats

// 65288@3 [0]
// 65289@1,2,4,5 [1-4]
// 65299@15 [5]
int 
er_group_hw_oam_mep_clear_counters(int action, struct er_attr_group_instance_t *attr_inst, struct me_t *me, unsigned char attr_mask[2])
{
	...
	case ER_ATTR_GROUP_HW_OP_UPDATE:
		//delete
		if (er_group_hw_oam_mep_clear_counters(ER_ATTR_GROUP_HW_OP_DEL, attr_inst, me, attr_mask) < 0)
		{
		...
		//add
		if (er_group_hw_oam_mep_clear_counters(ER_ATTR_GROUP_HW_OP_ADD, current_attr_inst, me, attr_mask) < 0)
		{
