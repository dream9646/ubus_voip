...
int
me_related_329_251(struct me_t *me1, struct me_t *me2)
{
...
int 
me_related_329_65289(struct me_t *me1, struct me_t *me2)	
{
	...
	if ((unsigned char)(attr1.data)==11 && (unsigned short)(attr2.data)==me1->meid)
		return 1;
	else
		return 0;
}
...
int 
me_related_329_65290(struct me_t *me1, struct me_t *me2)	
{
	struct attr_value_t attr1;
	struct attr_value_t attr2;
...
int
me_related_329_65317(struct me_t *me1, struct me_t *me2)
{
	if (me1 == NULL || me2 == NULL)
	{
		return 0;
