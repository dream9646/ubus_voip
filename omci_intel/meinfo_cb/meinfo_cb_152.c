...
//classid 152 9.9.15 SIP_call_initiation_performance_monitoring_history_data

static int 
meinfo_cb_152_create(struct me_t *me, unsigned char attr_mask[2])
{
...
struct meinfo_callback_t meinfo_cb_152 = {
	.create_cb			= meinfo_cb_152_create,
};
