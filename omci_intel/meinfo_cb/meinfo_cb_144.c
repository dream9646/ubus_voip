...
//classid 144 9.9.13 RTP_performance_monitoring_history_data

static int 
meinfo_cb_144_create(struct me_t *me, unsigned char attr_mask[2])
{
...
struct meinfo_callback_t meinfo_cb_144 = {
	.create_cb			= meinfo_cb_144_create,
};
