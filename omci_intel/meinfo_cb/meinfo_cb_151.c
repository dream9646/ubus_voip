...
//classid 151 9.9.14 SIP_agent_performance_monitoring_history_data

static int 
meinfo_cb_151_create(struct me_t *me, unsigned char attr_mask[2])
{
	struct meinfo_t *miptr=NULL;
	struct attr_value_t attr;
	unsigned char attr_order;
	unsigned char attr_mask2[2]={0x3f,0xfe};
...
struct meinfo_callback_t meinfo_cb_151 = {
	.create_cb			= meinfo_cb_151_create,
};
