...
//322 ethernet_frame_pm_upstream 9.3.30

static int 
meinfo_cb_322_create(struct me_t *me, unsigned char attr_mask[2])
{
...
struct meinfo_callback_t meinfo_cb_322 = {
	.create_cb	= meinfo_cb_322_create
};
