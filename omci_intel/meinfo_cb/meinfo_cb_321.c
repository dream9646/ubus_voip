...
//321 ethernet_frame_pm_downstream 9.3.31

static int 
meinfo_cb_321_create(struct me_t *me, unsigned char attr_mask[2])
{
	struct meinfo_t *miptr=NULL;
	struct attr_value_t attr;
	unsigned char attr_order;
	unsigned char attr_mask2[2]={0x3f,0xff};
...
struct meinfo_callback_t meinfo_cb_321 = {
	.create_cb	= meinfo_cb_321_create
};
