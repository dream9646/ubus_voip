...
//classid 137 9.12.3 Network_address

static int
meinfo_cb_137_check_update(struct me_t *me)
{
...
static int 
meinfo_cb_137_create(struct me_t *me, unsigned char attr_mask[2])
{
	batchtab_cb_wanif_me137_create();
	return meinfo_cb_137_check_update(me);
}

static int
meinfo_cb_137_delete(struct me_t *me)
{
	return batchtab_cb_wanif_me137_delete();
}

static int 
meinfo_cb_137_set(struct me_t *me, unsigned char attr_mask[2])
{
	return meinfo_cb_137_check_update(me);
}

struct meinfo_callback_t meinfo_cb_137 = {
	.create_cb	= meinfo_cb_137_create,
	.delete_cb	= meinfo_cb_137_delete,
	.set_cb		= meinfo_cb_137_set
};
