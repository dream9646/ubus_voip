...
//296 ethernet_pm_3 9.5.4 

static int 
meinfo_cb_296_create(struct me_t *me, unsigned char attr_mask[2])
{
...
struct meinfo_callback_t meinfo_cb_296 = {
	.create_cb	= meinfo_cb_296_create
};
