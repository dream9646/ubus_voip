...
int 
me_related_310_047(struct me_t *me1, struct me_t *me2)	
{
	return me_related_047_310(me2, me1);
}

// relation to 9.3.10 [130] 802.1p mapper service profile
int 
me_related_310_130(struct me_t *me1, struct me_t *me2)	
{
	return me_related_130_310(me2, me1);
}

// relation to 9.3.27 [309] Multicast operation profile
int 
me_related_310_309(struct me_t *me1, struct me_t *me2)	
{
