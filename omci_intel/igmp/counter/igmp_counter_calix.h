...
#ifndef __IGMP_COUNTER_CALIX_H__
#define __IGMP_COUNTER_CALIX_H__

struct igmp_pkt_calix_counter_t {
        unsigned short me47_id;
...
extern struct igmp_counter_module_t calix; 
#endif