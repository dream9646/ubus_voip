...
int mcast_pkt_parse_clientinfo(struct igmp_clientinfo_t *igmp_clientinfo);
int mcast_pkt_parse_clientinfo_router_mode(struct igmp_clientinfo_t *igmp_clientinfo);
int mcast_pkt_ip_cmp(union ipaddr *src_ip, union ipaddr *dst_ip);
int mcast_pkt_ip_cpy(union ipaddr *dst_ip, union ipaddr *src_ip);
#endif
